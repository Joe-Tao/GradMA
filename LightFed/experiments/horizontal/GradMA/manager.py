...
from models.model import model_pull
...
class ServerManager(BaseServer):
    ...
    def fed_finish_client_train_step(self,
        ...
        # decode client_model_params_buffer
...
class ClientManager(BaseServer):
    ...
    # Encode model_params_buffer to the server
